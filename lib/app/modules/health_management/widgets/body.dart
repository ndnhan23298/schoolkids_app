              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final name = "${controller.studentByClass[index].firstName} ${controller.studentByClass[index].lastName}";
                        ...
                        child: Row(
                          children: [
                            ...
                            GestureDetector(
                              ...
                              onTap: () {
                                Get.toNamed(Routes.DETAIL_HEALTH_STUDENT, parameters: {"studentName": ""});
                                controller.getHealthStudent(
                                    controller.studentByClass[index].id);
                              },
                            )
                          ],
                        ),
